...
# # print(x[0]['close'])
# df = client.Trade.Trade_getBucketed(binSize='1m',reverse=True,symbol='XBTUSD',count=10,partial=True).result()[0]
...
#     ohlcv_candles.set_index(['timestamp'],inplace=True)
#     ohlcv_candles.sort_values(by=['timestamp'],ascending=True,inplace=True)
#     print('volume current candle: {}'.format(ohlcv_candles['volume'][-1]))
